...
cd /d "%ROOT%"
echo Building ENHANCED Ages and Seasons (single-slot Biggoron) from:
echo   %ROOT%
echo.

"%BASH%" "%BUILD_SH%" enhanced
set "ERR=%ERRORLEVEL%"
...
echo.
echo Done:
echo   %ROOT%\ages_enhanced.gbc
echo   %ROOT%\seasons_enhanced.gbc
exit /b 0
