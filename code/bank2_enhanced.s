...
loadStatusBarMap:
	...
	inc c
+
	; HACK: single-slot Biggoron — no dual-slot HUD layout
	ld hl,wStatusBarNeedsRefresh
	ldd a,(hl)
	rrca
	ld a,c
...
;
; HACK: Biggoron's sword uses a single inventory slot like every other item
; (vanilla forces it onto both A and B — see bank2.s).
@equipItem:
